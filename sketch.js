...
neem.hide()
 ...
 mahogany=createButton('Neem');
 mahogany.position(displayWidth/2+255 , displayHeight-displayHeight+170);
mahogany.hide()

peepal=createButton('Peepal');
peepal.position(displayWidth/2+250 , displayHeight-displayHeight+240);
peepal.hide()

banyan=createButton('Mahogany');
banyan.position(displayWidth/2+250 , displayHeight-displayHeight+310);
banyan.hide()

t=createButton('T H A N K S');
t.position(displayWidth/2+255 , displayHeight-displayHeight+100);
t.hide()

 
f=createButton('  F   O   R  ');
 f.position(displayWidth/2+255 , displayHeight-displayHeight+170);
f.hide()

y =createButton('Y  O  U  R');
y.position(displayWidth/2+250 , displayHeight-displayHeight+240);
y.hide()

s=createButton('S U P P O R T');
s.position(displayWidth/2+250 , displayHeight-displayHeight+310);
s.hide()
